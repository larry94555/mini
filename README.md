...
| `MessageRedactingAppender.java` | Logback appender that scrubs secrets/PII from the message before the built-in `JsonEncoder` (structured `json` profile) |
