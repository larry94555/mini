...
| `scripts/check-docs.sh` | Fail if README/docs reference a test class, `.java` file, or TESTING case that doesn't exist (`WARN_ONLY=1` to report-only); runs in CI |
